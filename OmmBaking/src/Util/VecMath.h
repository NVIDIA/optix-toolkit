...
* @{
*/
VECTOR_MATH_API ushort2 make_ushort2( const unsigned short s )
{
    return make_ushort2( s, s );
}
VECTOR_MATH_API ushort2 make_ushort2( const float2& a )
{
    return make_ushort2( ( unsigned short )a.x, ( unsigned short )a.y );
}
/** @} */
...
* @{
*/
VECTOR_MATH_API ushort2 operator+( const ushort2& a, const ushort2& b )
{
    return make_ushort2( a.x + b.x, a.y + b.y );
}
VECTOR_MATH_API void operator+=( ushort2& a, const ushort2& b )
{
    a.x += b.x;
    a.y += b.y;
}
...
VECTOR_MATH_API ushort2 operator-( const ushort2& a, const unsigned short b )
{
...
VECTOR_MATH_API ushort2 operator*( const ushort2& a, const unsigned short s )
{
    return make_ushort2( a.x * s, a.y * s );
}
VECTOR_MATH_API ushort2 operator*( const unsigned short s, const ushort2& a )
{
    return make_ushort2( a.x * s, a.y * s );
}
VECTOR_MATH_API void operator*=( ushort2& a, const unsigned short s )
{
    a.x *= s;
    a.y *= s;
}
...
* @{
*/
VECTOR_MATH_API bool operator==( const ushort2& a, const ushort2& b )
{
    return a.x == b.x && a.y == b.y;
}
...
/** If used on the device, this could place the the 'v' in local memory */
VECTOR_MATH_API unsigned short getByIndex( const ushort2& v, unsigned int i )
{
