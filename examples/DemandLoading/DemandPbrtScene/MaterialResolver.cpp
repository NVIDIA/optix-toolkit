...
MdlShaderKey makeMaterialGroupMdlShaderKey( const MaterialGroup& group )
{
    if( group.pbrtMaterial )
    {
        return makeMdlShaderKey( *group.pbrtMaterial );
    }
    return MdlShaderKey{ "pbrt-mdl-v1|missing-pbrt-material" };
}
#endif
