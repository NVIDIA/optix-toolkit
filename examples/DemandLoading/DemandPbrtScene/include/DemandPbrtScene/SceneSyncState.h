...
struct SceneSyncState
{
...
#ifdef OTK_USE_MDL
    otk::SyncVector<MdlMaterialShader> mdlMaterialShaders;  // indexed by MaterialState::shaderKey
#endif
    ...
    otk::SyncVector<PhongMaterial>     realizedMaterials;   // indexed by materialId
