...
void TestJsonStatisticsPrinter::SetUp()
{
    ...
    m_stats.materials.mdlShaders.numCompileRequests         = 31;
    m_stats.materials.mdlShaders.numCompletedCompiles       = 32;
    m_stats.materials.mdlShaders.numMissingShaders          = 33;
    m_stats.materials.mdlShaders.numQueuedShaders           = 34;
    m_stats.materials.mdlShaders.numCompilingShaders        = 35;
    m_stats.materials.mdlShaders.numReadyShaders            = 36;
    m_stats.materials.mdlShaders.numFailedShaders           = 37;
#endif
    ...
    m_expectedStatsJson =
        ...
        R"json("materials":{)json"
            ...
            R"json("mdlShaders":{)json"
                ...
                R"json("numCompileRequests":31,)json"
                R"json("numCompletedCompiles":32,)json"
                R"json("numMissingShaders":33,)json"
                R"json("numQueuedShaders":34,)json"
                R"json("numCompilingShaders":35,)json"
                R"json("numReadyShaders":36,)json"
                R"json("numFailedShaders":37)json"
            R"json(})json"
#endif
        R"json(},)json"
        R"json("scene":{)json"
