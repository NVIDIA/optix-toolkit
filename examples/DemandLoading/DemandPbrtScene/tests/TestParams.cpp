...
TEST( TestMdlMaterialTextureBindings, defaultMdlMaterialShaderHasNoBoundTextures )
{
    ...
    EXPECT_EQ( CUdeviceptr{}, data.tintArgumentBlock );
    EXPECT_EQ( CUdeviceptr{}, data.bsdfArgumentBlock );
    EXPECT_EQ( 0U, data.bsdfArgumentBlockSize );
...
TEST( TestMdlMaterialTextureBindings, setBindingTracksCountAndRejectsOverflow )
{
    ...
    EXPECT_EQ( 888U, data.textureBindings[MDL_MATERIAL_VROUGHNESS_TEXTURE_BINDING_INDEX].textureId );
