...
void DeviceConstantImage::open( imageSource::TextureInfo* info )
{
    if( info != nullptr )
        *info = m_info;
}

bool DeviceConstantImage::readTile( char* dest, unsigned int mipLevel, const imageSource::Tile& tile, CUstream stream )
{
