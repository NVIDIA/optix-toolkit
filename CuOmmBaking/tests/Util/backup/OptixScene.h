...
class OptixOmmScene
{
  public:
    ...
    OptixResult build( OptixDeviceContext context, const char* ptxInput, const size_t ptxInputSize, const OptixOmmArray& optixOmm, const ommBaking::BakeInputDesc* ommBuildInput, unsigned int numBuildInputs );
  ...
  private:
    OptixResult buildGAS( const OptixOmmArray& optixOmm, const ommBaking::BakeInputDesc* ommBuildInput, unsigned int numBuildInputs );

    OptixResult buildSBT( const ommBaking::BakeInputDesc* ommBuildInput, unsigned int numBuildInputs );
